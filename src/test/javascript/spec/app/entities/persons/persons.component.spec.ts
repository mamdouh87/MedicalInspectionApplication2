...
import { PersonsComponent } from 'app/entities/persons/persons.component';
...
describe('Component Tests', () => {
  describe('Persons Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.persons && comp.persons[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
