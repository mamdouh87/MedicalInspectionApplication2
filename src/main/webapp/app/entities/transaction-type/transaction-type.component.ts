...
export class TransactionTypeComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.transactionTypeService
      ...
      .subscribe(
        (res: HttpResponse<ITransactionType[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  protected onSuccess(data: ITransactionType[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
