package com.isoft.medical.inspection.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.isoft.medical.inspection.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.isoft.medical.inspection.repository.UserRepository.USERS_BY_EMAIL_CACHE);
