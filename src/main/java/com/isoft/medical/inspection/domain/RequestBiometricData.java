...
public class RequestBiometricData extends AbstractAuditingEntity implements Serializable {
    ...
    public RequestBiometricData image(byte[] image) {
        this.image = image;
        return this;
    }
    ...
    public RequestBiometricData imageContentType(String imageContentType) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RequestBiometricData)) {
            return false;
        }
        return id != null && id.equals(((RequestBiometricData) o).id);
    }
